...
export default class EditToolbar extends React.Component {
    render() {
        const { canAddSong, canUndo, canRedo, canClose, editOpen, 
        ...
        return (
            ...
            <input 
                ...
                disabled={!canUndo || !canClose || editOpen}
            />
            <input 
                type="button" 
                id='redo-button' 
                ...
                disabled={!canRedo || !canClose || editOpen}
            />
            <input 
                type="button" 
                id='close-button' 
